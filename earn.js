...
const VIDEO_TASK_LIMITS = {
    task1: { maxCount: 4, reward: 50, watchCooldown: 60 * 1000,      dailyCooldown: 2 * 60 * 60 * 1000, blockId: '23898' },
    task2: { maxCount: 4, reward: 50, watchCooldown: 60 * 1000,      dailyCooldown: 2 * 60 * 60 * 1000, blockId: '23919' },
    task3: { maxCount: 4, reward: 50, watchCooldown: 60 * 1000,      dailyCooldown: 2 * 60 * 60 * 1000, blockId: '24540' },
    task4: { maxCount: 4, reward: 50, watchCooldown: 60 * 1000,      dailyCooldown: 2 * 60 * 60 * 1000, blockId: '24541' },
    task5: { maxCount: 4, reward: 50, watchCooldown: 60 * 1000,      dailyCooldown: 2 * 60 * 60 * 1000, blockId: '24542' },
    task6: { maxCount: 4, reward: 50, watchCooldown: 60 * 1000,      dailyCooldown: 2 * 60 * 60 * 1000, blockId: '24543' },
    task7: { maxCount: 4, reward: 50, watchCooldown: 60 * 1000,      dailyCooldown: 2 * 60 * 60 * 1000, blockId: '24544' }
};
...
router.post('/video', async (req, res) => {
    try {
        ...
        const cfg = VIDEO_TASK_LIMITS[taskId];
        if (amount !== cfg.reward) return res.status(400).json({ error: 'Invalid reward amount' });
        ...
        console.log(`✅ User ${req.tgUser.id} earned ${cfg.reward} coins from ${taskId} (${taskData.count}/${cfg.maxCount}). Total: ${user.coins}`);
